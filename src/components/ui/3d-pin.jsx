    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.2)] bg-white border-4 border-green-500 group-hover/pin:border-green-600 transition duration-700 overflow-hidden"
        >
