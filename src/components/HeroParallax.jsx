  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-4xl md:text-7xl font-bold text-gray-800">
        Dokumentasi Kegiatan <br /> Periode 2025
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-gray-600">
        Berbagai kegiatan TIM KKN-PPM Menyapa Komodo dari tahun ke tahun yang telah dilaksanakan untuk kemajuan Kecamatan
        Komodo. Dari pendidikan, kesehatan, hingga pemberdayaan masyarakat
        lokal.
      </p>
    </div>
  );
